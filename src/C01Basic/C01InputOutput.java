...
////        입력1 : Scanner클래스 - 입력을 위한 클래스로서 바이트 단위 입력처리.
////      System.in은 키보드 입력을 의미한다. 파일 입력도 가능하다.
...
////        입력2 : BufferedReader : 1) Buffer를 활용하여 더 좋은 성능 2) InputStreamReader 는 바이트 대신 문자 단위로 입력
...
////        close()는 메모리 회수.
////        java Gravage Collerter(GC)는 java 프로그램 내부의 메모리만 관리한다.
////        외부 입출력 장치와 연계된 코드이므로, GC의 대상이 아님
//        br.close();
