...
////        변수의 명명규칙
////        변수 명에 의미의 분절이 일어나는 경우에는 camelcase 또는 _ 사용
//        String myFirstName = "hongildong";
//        String mu_first_name = "hongildong";
//
////        정수 : byte(1바이트), int(4바이트) 40억정도, long(8바이트)
//        byte a = 127;
//        byte b = -128;
//
...
////
//        long l1 = 10;
////        long은 명시적으로 L을 붙여서 해당 값이 long 타입임을 명시
//        long l2 = 20L;
...
//
////        소수점 연산 오차 해결방법1 : 소수를 정수로 변환 후 추후 다시 나눗셈으로 값을 변환
//        double total2 = 0;
//        for(int i=0; i<1000; i++){
//            total2 += (0.1*10);
//        }
...
////        값을 입력받아 저장할 때 부터 문자로 입력을 받아 오차 문제를 해결(돈, 환율)
...
//        char c1 = '가';
//        String st1 = "가";
////        String 또는 char 배열 최초 선언시 초기값이 null이 할당(int = 0, boolean = false)
//        String[] stArr = new String[10];
//        System.out.println(stArr[0]);
//
////        null은 값이 없다는 의미로써 하나의 type
//        String st1 = ""; // 빈 문자열 할당
//        String st2 = null; // null 할당. st2는 더이상 String이 아님.
//        System.out.println(st1.isEmpty()); // true
//        System.out.println(st2.isEmpty()); // error - NullPointerException

//        String[] stArr = new String[5];
//        stArr[1] = "hello world 1";
//        stArr[3] = "hello world 3";
//
...
////        타입변환 : (기본방향)작은 타입에서 큰 타입으로의 변환은 문제없이 변환
////        int -> long : 문제 없음
//        int i1 = 10;
//        long l1 = i1;
//
...
////        두 수가 모두 정수이면 결과값도 정수일 것이다라고 java가 판단
////        -> 두 수중 하나를 double로 변환시켜 해결
//        int a = 1;
//        int b = 4;
//        double d1 = (a/b); // int값이 double에 저장되므로 소수점은 싹 날아간다.
...
//        상수 : 값의 재할당 불가능. 정해진 값(고정된 값)을 사용시 상수 활용.
