...
//        else if (inputMoney >= 3000)
//            System.out.println("버스를 타시오");
////        3000원 미만이면 걸어가시오 출력
//        else
//            System.out.println("걸어가시오");

////        if문을 독립적으로 두고 싶은 경우에는 정확한 범위 지정을 통해 if문이 중복되어 실행되지 않도록 해야함.
//        if(inputMoney >= 10000)
//            System.out.println("택시를 타시오");
////        10000미만 ~ 3000원 이상이면 버스를 타시오 출력
//        if (inputMoney >= 3000 && inputMoney < 10000)
//            System.out.println("버스를 타시오");
////        3000원 미만이면 걸어가시오 출력
//        if(inputMoney < 3000)
//            System.out.println("걸어가시오");
...
//        switch문 : if, else if, else if 등 여러 조건문이 있을 때 조건문을 가독성 있게 표현한 구문
        Scanner sc = new Scanner(System.in);
        int input = Integer.parseInt(sc.nextLine());
//        input과 case의 값들은 equal관계이고, 구문마다 반드시 break를 넣어줘야함.
//        default는 그 외의 의미로써 else와 같은 의미.
        switch(input){
            case 1:
